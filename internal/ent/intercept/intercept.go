...
// The QuotaTransactionFunc type is an adapter to allow the use of ordinary function as a Querier.
type QuotaTransactionFunc func(context.Context, *ent.QuotaTransactionQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f QuotaTransactionFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.QuotaTransactionQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.QuotaTransactionQuery", q)
}

// The TraverseQuotaTransaction type is an adapter to allow the use of ordinary function as Traverser.
type TraverseQuotaTransaction func(context.Context, *ent.QuotaTransactionQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseQuotaTransaction) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseQuotaTransaction) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.QuotaTransactionQuery); ok {
		return f(ctx, q)
	}
...
// The UserQuotaFunc type is an adapter to allow the use of ordinary function as a Querier.
type UserQuotaFunc func(context.Context, *ent.UserQuotaQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f UserQuotaFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.UserQuotaQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.UserQuotaQuery", q)
}

// The TraverseUserQuota type is an adapter to allow the use of ordinary function as Traverser.
type TraverseUserQuota func(context.Context, *ent.UserQuotaQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseUserQuota) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseUserQuota) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.UserQuotaQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.UserQuotaQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.UserQuotaQuery:
		return &query[*ent.UserQuotaQuery, predicate.UserQuota, userquota.OrderOption]{typ: ent.TypeUserQuota, tq: q}, nil
