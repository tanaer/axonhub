...
var (
	...
	RechargeOrdersColumns = []*schema.Column{
		...
		{Name: "user_id", Type: field.TypeInt},
		{Name: "type", Type: field.TypeEnum, Enums: []string{"recharge", "package"}, Default: "recharge"},
		{Name: "amount", Type: field.TypeInt64},
		...
		{Name: "trade_id", Type: field.TypeString, Nullable: true},
		{Name: "paid_amount", Type: field.TypeInt64, Nullable: true},
	...
	RechargeOrdersTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			{
				Name:    "rechargeorder_order_id",
				Unique:  true,
				Columns: []*schema.Column{RechargeOrdersColumns[3]},
			},
			{
